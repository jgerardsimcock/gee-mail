...
//This function tells how many messages to load and how to generate messages//
...
//This function defines message variables date/subject/sender and bodt and instructs how to get string values from array variables defined above//
...
//this function is a random number generator that chooses that position within the array. The numbers are limited to the number of values of values in the array//
function getRandomElement(arr){
	return arr[Math.floor(Math.random() * arr.length)];
}

//This function generates a new message after the previous message has completed loading//
function getNewMessage(){
	var now = new Date();
	return generateMessage(now);
}
//This function is the random date generator. The values are limited to the those in a 12 month/24 hour cylce//
...
//This calls the function and gets the intial GeeMail data to window object//
(function(){
	window.geemails = [];
